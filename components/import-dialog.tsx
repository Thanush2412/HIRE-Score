...
const PRIMARY_FIELDS = [
  ...
  { key: "cefrA1Grammar",       label: "CEFR A1 Grammar",          primaryKey: false, headerMatches: ["a1 grammar", "cefr a1", "a1"] },
  { key: "cefrA2Grammar",       label: "CEFR A2 Grammar",          primaryKey: false, headerMatches: ["a2 grammar", "cefr a2", "a2"] },
