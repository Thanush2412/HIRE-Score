...
export async function upsertStudent(
  ...
  const promises = [
    ...
    sb.from("student_communication").upsert({
      student_id: studentId,
      cefr_a1_grammar: computed.cefrA1Grammar,
      cefr_a2_grammar: computed.cefrA2Grammar,
    ...
    sb.from("student_scores").upsert({
      ...
      cefr_a1_score: computed.cefrA1Score,
      cefr_a2_score: computed.cefrA2Score,
...
export async function logSubmission(
  ...
  const { error } = await sb.from("student_submissions_log").insert({
    ...
    cefr_a1_grammar: payload.cefrA1Grammar,
    cefr_a2_grammar: payload.cefrA2Grammar,
